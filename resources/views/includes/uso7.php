        ...
        <div class="row">
            <div id="carousel-reviews" class="carousel slide" data-ride="carousel">
              ...
              <div class="person-text rel">
                        <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/Flag_of_Canada.png'; ?>" alt=""/>
                <a title="" href="#">Canadian high commision</a>
                <i>Kenya</i>
              </div>
            </div>
                  <div class="col-md-2">
              ...
              <div class="person-text rel">
                        <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/choppies.png'; ?>" alt=""/>
                    <a title="" href="#">Choppies supermarket</a>
                <i>Kenya</i>
              </div>
            </div>
            <div class="col-md-2 ">
              ...
              <div class="person-text rel">
                <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/kncci.jpg'; ?>" alt=""/>
                <a title="" href="#">Kenya national chambers of commerce</a>
                <i>Kenya</i>
              </div>
            </div>
            </div>
              ...
              <div class="person-text rel">
                <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/kmd.jpg'; ?>" alt=""/>
                <a title="" href="#">kenya meteorogical</a>
                <i>Kenya</i>
              </div>
            </div>
                  <div class="col-md-2">
            ...
            <div class="col-md-2">
              ...
              <div class="person-text rel">
                <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/galitos.png'; ?>" alt=""/>
                <a title="" href="#">Galitos</a>
                <i>Kenya</i>
              </div>
            </div>
                    </div>
              ...
              <div class="person-text rel">
               <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/giz.png'; ?>" alt=""/>
                <a title="" href="#">Giz Kenya</a>
                <i>Kenya</i>
              </div>
            </div>
                  <div class="col-md-2">
              ...
              <div class="person-text rel">
                <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/faoLogo.jpg'; ?>" alt=""/>
                    <a title="" href="#">FAO Somalia</a>
                <i>Kenya</i>
              </div>
            </div>
            <div class="col-md-2">
              ...
              <div class="person-text rel">
                <img height="70px" src="<?php echo BASE_URL . '/assets/images/clients/saint-gobain.png'; ?>" alt=""/>
                <a title="" href="#">Saint gobain</a>
                <i>Kenya</i>
              </div>
            </div>
                    </div>                    
