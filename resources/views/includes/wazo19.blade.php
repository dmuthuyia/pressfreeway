...
<body>
  ...
  <ul>
    ...
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Users</a>
      <ul class="wazo19mobiledropdown-menu">
        <li><a href="{{ route('users.manage') }}">Manage Users</a></li>
        <li><a href="{{ route('students.manage') }}">Student</a></li>
        <li><a href="#">Parents</a></li>
        <li><a href="{{ route('staff.manage') }}">Staff</a></li>
      </ul>
    </li>
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Fee</a>
      <ul class="wazo19mobiledropdown-menu">
        <li><a href="{{ route('fees.manage') }}">Manage Fee</a></li>
    ...
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Classes</a>
      <ul class="wazo19mobiledropdown-menu">
        <li><a href="{{ route('levels.manage') }}">Manage classes</a></li>
        
      </ul>
    </li>
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Subjects</a>
      <ul class="wazo19mobiledropdown-menu">
        <li><a href="{{ route('subjects.manage') }}">Manage Subjects</a></li>
      </ul>
    </li>
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Years and Terms</a>
      <ul class="wazo19mobiledropdown-menu">
        <li><a href="#">Manage years and Terms</a></li>
      </ul>
    </li>
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Events</a>
      <ul class="wazo19mobiledropdown-menu">
    ...
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Notice board</a>
      <ul class="wazo19mobiledropdown-menu">
    ...
    <li class="wazo19mobiledropdown">
      <input type="checkbox" />
      <a href="#" data-toggle="wazo19mobiledropdown">Timetable</a>
      <ul class="wazo19mobiledropdown-menu">
