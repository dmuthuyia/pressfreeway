...
<title>Mega Drop Down wazo6</title>
<!--[if IE 6]>
<style>
body {behavior: url("csshover3.htc");}
#wazo6 li .drop {background:url("img/drop.gif") no-repeat right 8px; 
</style>
<![endif]-->
...
<ul id="wazo6">
    ...
    <li><a href="#" class="drop">Home</a><!-- Begin Home Item -->
        ...
        <div class="dropdown_2columns"><!-- Begin 2 columns container -->
            ...
            <div class="col_2">
                <p>Hi and welcome here ! This is a showcase of the possibilities of this awesome Mega Drop Down wazo6.</p>             
            ...
            <div class="col_1">
                <img src="<?php echo BASE_URL . '/assets/images/wazo6/browsers.png'; ?>" width="125" height="48" alt="" />
                
            </div>
            
            <div class="col_1">
                <p>This mega wazo6 has been tested in all major browsers.</p>
            </div>
    ...
    <li><a href="#" class="drop">5 Columns</a><!-- Begin 5 columns Item -->
        ...
        <div class="dropdown_5columns"><!-- Begin 5 columns container -->
            ...
            <div class="col_3">
                ...
                <img src="<?php echo BASE_URL . '/assets/images/wazo6/01.jpg'; ?>" width="70" height="70" class="img_left imgshadow" alt="" />
                ...
                <img src="<?php echo BASE_URL . '/assets/images/wazo6/02.jpg'; ?>" width="70" height="70" class="img_left imgshadow" alt="" />
    ...
    <li class="wazo6_right"><a href="#" class="drop">1 Column</a>
    ...
    <li class="wazo6_right"><a href="#" class="drop">3 columns</a><!-- Begin 3 columns Item -->
