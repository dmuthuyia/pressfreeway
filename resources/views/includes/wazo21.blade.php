...
@font-face {
  ...
  src: url('https://github.com/FortAwesome/Font-Awesome/raw/master/font/fontawesome-webfont.eot');
  src: url('https://github.com/FortAwesome/Font-Awesome/raw/master/font/fontawesome-webfont.eot?#iefix') format('eot'), url('https://github.com/FortAwesome/Font-Awesome/raw/master/font/fontawesome-webfont.woff') format('woff'), url('https://github.com/FortAwesome/Font-Awesome/raw/master/font/fontawesome-webfont.ttf') format('truetype'), url('https://github.com/FortAwesome/Font-Awesome/raw/master/font/fontawesome-webfont.svg#FontAwesomeRegular') format('svg');
  font-weight: normal;
  font-style: normal;
}
...
/* Defaut link style */
#access a, #access #wazo21menu a, #wazo21menu li a {
...
#access a:hover, #access #wazo21menu a:hover, #access a.skip-link.focus, #access #wazo21menu a.skip-link.focus, #wazo21menu li a:hover {
...
#access a.skip-link, #access #wazo21menu a.skip-link {
  position: relative;
  z-index: 2;
}
#access a.skip-link span, #access #wazo21menu a.skip-link span {
  position: absolute;
  right: 0.5em;
  top: 0.5em;
...
#access #wazo21menu li.active a a, #access #wazo21menu li.active a a:hover, #access #wazo21menu li.active:nth-child(odd) a, #access #wazo21menu li.active:nth-child(odd) a:hover {
...
@media only screen and (max-width: 768px) {
  ...
  #wazo21menu li.active a:before, #wazo21menu li a:hover:before {
    opacity: 1;
  }
  #wazo21menu li a:hover:before {
    color: #689384;
  }
  #wazo21menu li.active a:before, #wazo21menu li.active a:hover:before {
    color: #fff;
  }
  #wazo21menu:target, #wazo21menu.target {
    margin-top: 0;
  }
  #wazo21menu:target li, #wazo21menu.target li {
    max-height: 2.5em;
    height: auto;
  }
  #wazo21menu:target li a, #wazo21menu.target li a {
...
@media only screen and (min-width: 769px) {
  ...
  <nav role="navigation" id="access">
    <a class="skip-link icon-reorder" title="Accéder au wazo21menu" href="#wazo21menu">Menu</a>
    <ul id="wazo21menu">
      <li class="active"><a class="icon-home" href="#accueil">Home</a></li><!-- whitespace
                --><li><a class="icon-group" href="#quisommesnous">Shuleh chat</a></li><!-- whitespace
                --><li><a class="icon-leaf" href="#services">Timetable</a></li><!-- whitespace
                --><li><a class="icon-picture" href="#portfolio">Events</a></li><!-- whitespace
                --><li><a class="icon-envelope-alt" href="#contact">notifications</a></li>
                <li><a class="icon-envelope-alt" href="#contact">School website</a></li>
                   <li><a class="icon-envelope-alt" href="#contact">Account</a></li>
          </ul>
      </nav>
</div>
...
;(function($) {
    ...
    $(document).ready(function() {
        ...
        }).find('.skip-link').append('<span>'+$('#wazo21menu .active').text()+'</span>');
    });
})(jQuery);
