...
<body>
    ...
    <div class="container">
        ...
        <div id="slider1_container" style="visibility: hidden; position: relative; margin: 0 auto; width: 1140px; height: 442px; overflow: hidden;">
            ...
            overflow: hidden;">
                <div>
                    <img u="image" src2="<?php echo BASE_URL . '/assets/images/uso/banner1.png'; ?>" />
                </div>
                <div>
                    <img u="image" src2="<?php echo BASE_URL . '/assets/images/uso/banner2.png'; ?>" />
                </div>
                <div>
                    <img u="image" src2="<?php echo BASE_URL . '/assets/images/uso/banner3.png'; ?>" />
                </div>
                <div>
                    <img u="image" src2="<?php echo BASE_URL . '/assets/images/uso/banner2.png'; ?>" />
                </div>
